...
?>
 <fieldset class="titleform">
 	<div class="alert alert-warning">
    	<?php echo ossn_print('theme:rgx:browercache');?>
    </div>	
 	<div>	
    	<label><?php echo ossn_print('theme:rgx:logo:site');?> (450x90 - 500 KB) </label>
        <input type="file" name="logo_site" />
        <div class="logo-container-rgx">
        		<?php
  	...
  	<div>	
    	<label><?php echo ossn_print('theme:rgx:logo:admin');?> (180x45 - 500 KB)</label>
    ...
    <a href="<?php echo ossn_site_url("action/rgx/settings/logos_bgs_reset", true);?>" class="btn btn-danger d-inline-block right btn-sm"><i class="fa-solid fa-rotate"></i> Reset</a>
</fieldset>
